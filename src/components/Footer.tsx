        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 sm:gap-16 md:gap-20 mb-2">
          <div className="space-y-8 sm:space-y-10">
            <div className="flex items-center gap-3 sm:gap-4 lg:gap-6">
              <div className="w-10 sm:w-12 lg:w-14 h-10 sm:h-12 lg:h-14 bg-white rounded-lg sm:rounded-2xl flex items-center justify-center p-2 shadow-2xl shadow-white/5 flex-shrink-0">
                <img src="images/ask.jpeg" alt="ASK" className="w-full h-full object-contain" />
              </div>
              <div className="flex flex-col min-w-0">
                <span className="text-lg sm:text-xl lg:text-2xl font-bold text-white heading-serif leading-tight tracking-tight">ASK & BAALAM</span>
                <span className="text-[8px] sm:text-[9px] lg:text-[10px] font-bold tracking-[0.2em] sm:tracking-[0.25em] lg:tracking-[0.3em] text-orange-500 uppercase mt-1">Educational Societies</span>
              </div>
            </div>
            ...
            <div className="flex gap-3 sm:gap-4">
              <a href="#" className="w-10 sm:w-12 h-10 sm:h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center hover:bg-blue-600 hover:border-blue-600 transition-all group shadow-2xl flex-shrink-0"><Facebook size={18} className="md:w-5 md:h-5 text-slate-400 group-hover:text-white transition-colors" /></a>
              <a href="#" className="w-10 sm:w-12 h-10 sm:h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center hover:bg-red-600 hover:border-red-600 transition-all group shadow-2xl flex-shrink-0"><Youtube size={18} className="md:w-5 md:h-5 text-slate-400 group-hover:text-white transition-colors" /></a>
              <a href="#" className="w-10 sm:w-12 h-10 sm:h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center hover:bg-pink-600 hover:border-pink-600 transition-all group shadow-2xl flex-shrink-0"><Instagram size={18} className="md:w-5 md:h-5 text-slate-400 group-hover:text-white transition-colors" /></a>
            </div>
          </div>
          ...
          <div>
            <h4 className="text-white font-bold mb-6 sm:mb-8 lg:mb-10 uppercase tracking-[0.2em] sm:tracking-[0.25em] lg:tracking-[0.3em] text-[9px] sm:text-[10px]">Registry Office</h4>
            <ul className="space-y-4 sm:space-y-6 lg:space-y-8 text-xs sm:text-sm font-bold">
              <li className="flex items-start gap-3 sm:gap-4 lg:gap-6">
                ...
                <span className="leading-relaxed text-slate-400 text-xs sm:text-sm">Vidyanagar, Hyderabad,<br />Telangana, India - 500044</span>
              </li>
