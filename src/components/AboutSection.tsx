          ...
          <div className="space-y-8 sm:space-y-10 md:space-y-12">
            <div>
              <div className="mt-8 sm:mt-10 md:mt-12 space-y-6 sm:space-y-8 md:space-y-10 text-base sm:text-lg md:text-xl text-slate-600 leading-relaxed font-medium">
                <p>
                  ASK EDUCATIONAL SOCIETY started as an afterschool program to coach students in Higher order thinking skills. 11. After a decade in corporate coaching market as Chemistry teacher - Padmaja wanted to start her own academy to bridge the gaps in foundational coaching.
                </p>
                <p>
